...
PROGRAM MC3  
    ...
    ! S'OBRE EL FIXTER DE DADES, ÚNIC PER CADA EXECUTABLE (UN CODI DE PYTHON DESPRÉS HO AJUNTA I ORDENA TOT), ES DEFINEIX
    ...
    DO L = 12, 72, 12
        ...
        ! ES COMENÇA EL BUCLE DE TEMPERATURES, IMPRIMINT PER PATNTALLA QUINA T S'ESTÀ CALCULANT PER SEGUIR EL PROGRÉS DEL PROGRAMA
        ...
        DO TEMPINDEX = ITINDEX, FTINDEX, PASTINDEX
            ...
            WRITE(1,*) L, TEMP, SUM, SUME, SUME2, VARE, SUMM, SUMAM, SUMM2, VARM, DBLE(PASTINDEX)/1000.D0
